            ...
            <Table sx={{ width: '100%' }} aria-label="simple table">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="left">Total Assets Count</TableCell>
                  <TableCell align="right">Allocated Assets</TableCell>
                  <TableCell align="right">Assets under Maintenance</TableCell>
                  <TableCell align="right">Non Allocated Assets</TableCell>
              ...
              <TableBody>
                {data.CategoryData.map((v, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell align="right">{v.allocated}</TableCell>
                    <TableCell align="right">{v.underMaintenance}</TableCell>
                    <TableCell align="right">{Number(v.count)-(Number(v.allocated) + Number(v.underMaintenance))}</TableCell>
